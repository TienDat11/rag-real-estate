...
from ...domain.value_objects.constants import MAX_QUERY_LENGTH
...
async def _sse_stream(pipe, req: QueryRequest, as_of: str | None) -> AsyncIterator[str]:
    ...
    from ....application.pipelines.workflow import QueryRejected  # noqa: PLC0415
...
def create_app() -> FastAPI:
    from ...infrastructure.config.config import export_runtime_env  # noqa: PLC0415
    ...
    async def _shutdown() -> None:
        from ....application.services.audit import close_audit_pool  # noqa: PLC0415
        from ....domain.services.nl2sql_guard import close_nl2sql_pool  # noqa: PLC0415
        from ....application.services.sql_leg import close_ro_pool  # noqa: PLC0415
    ...
    async def ready() -> dict:
        ...
        from ....application.services.rag_leg import LIGHTRAG_READY  # noqa: PLC0415
        from ....application.services.sql_leg import get_ro_pool  # noqa: PLC0415
    ...
    async def query(req: QueryRequest, request: Request) -> "StreamingResponse | dict":
        from ....application.pipelines.workflow import QueryRejected, RagQueryWorkflow as RagQueryPipeline  # noqa: PLC0415
