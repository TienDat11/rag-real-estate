...
from api.constants import DEFAULT_LLM_TIMEOUT_S, DEFAULT_MODEL_ANSWER
...
class OpenAICompatibleLLM(LLMChatPort):
    ...
    async def complete(
        ...
        *,
        ...
        except Exception as exc:  # noqa: BLE001 — provider error degrades in the caller
        ...
        try:
            ...
            async for chunk in stream:
                ...
                if delta and delta.content:
                    yield delta.content
        except Exception as exc:  # noqa: BLE001 — caller (workflow) degrades, not crashes
